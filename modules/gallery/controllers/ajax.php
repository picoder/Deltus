...
class Ajax extends DV_Controller {
				...
				if ($out) {
					...
					if ($in) {
						...
						if($chunk == 0)
						{
							...
							$this->gallery_lib->add_tempfile($fileName);
						}
					} else
...
/* Location: ./modules/gallery/controllers/ajax.php */