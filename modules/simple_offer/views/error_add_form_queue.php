...
<div class="form">
<?php
echo form_open_multipart($this->config->item('backend_url').'/'.$this->config->item('simple_offer_content_url').'/add');
?>
<div class="v_f">
...
<div class="v_f">
<?php
echo form_label('Label', 'offer_label');
...
<div class="v_f">
<?php
echo form_label('Description', 'offer_description');
...
<div class="v_f">
<?php
echo form_label('Content', 'offer_content');
...
<div class="v_f">
<?php
echo form_submit('mysubmit', 'Add Simple Offer');
?>
</div>
