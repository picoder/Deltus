<?php  
	...
	$this->set_css('modules/crud/assets/grocery_crud/themes/flexigrid/css/flexigrid.css');
	$this->set_js('modules/crud/assets/grocery_crud/js/jquery-1.7.1.min.js');
	$this->set_js('modules/crud/assets/grocery_crud/themes/flexigrid/js/cookies.js');
	$this->set_js('modules/crud/assets/grocery_crud/themes/flexigrid/js/flexigrid.js');
	$this->set_js('modules/crud/assets/grocery_crud/themes/flexigrid/js/jquery.form.js');
	$this->set_js('modules/crud/assets/grocery_crud/themes/flexigrid/js/jquery.numeric.js');
