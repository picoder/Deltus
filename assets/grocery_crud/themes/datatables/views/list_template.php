<?php  
	...
	$this->set_css('modules/crud/assets/grocery_crud/themes/datatables/css/demo_table_jui.css');
	$this->set_css('modules/crud/assets/grocery_crud/themes/datatables/css/ui/simple/jquery-ui-1.8.10.custom.css');
	$this->set_css('modules/crud/assets/grocery_crud/themes/datatables/css/datatables.css');	
	$this->set_js('modules/crud/assets/grocery_crud/js/jquery-1.7.1.min.js');
	$this->set_js('modules/crud/assets/grocery_crud/themes/datatables/js/jquery-ui-1.8.10.custom.min.js');
	$this->set_js('modules/crud/assets/grocery_crud/themes/datatables/js/jquery.dataTables.min.js');
	$this->set_js('modules/crud/assets/grocery_crud/themes/datatables/js/datatables.js');
?>
