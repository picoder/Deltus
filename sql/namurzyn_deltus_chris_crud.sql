...
--
-- Host: localhost
-- Czas wygenerowania: 01 Mar 2012, 15:04
...
--
-- Baza danych: `namurzyn_deltus_chris_crud`
--
...
--
-- Struktura tabeli dla  `foos_jobs`
--

CREATE TABLE IF NOT EXISTS `foos_jobs` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Zrzut danych tabeli `foos_jobs`
--

INSERT INTO `foos_jobs` (`id`, `foo_id`, `job_id`) VALUES
(1, 1, 2),
(2, 1, 1),
(3, 2, 1);
...
(1, 'scientist', '<p>Pracownik naukowy.</p>'),
(2, 'mechanic', '<p>Naprawia samochody.</p>');
...
(1, 'thiede', '$P$BtgjMG7AH4vcHtSMC/J.//b0cQY5680', 'thiede@promo-expo.pl', 1, 0, NULL, NULL, NULL, NULL, 'f3a971f1edc23a890f62b161c1417927', '127.0.0.1', '2012-03-01 14:46:48', '2011-09-26 15:25:22', '2012-03-01 14:46:48'),
