...
class Tank_auth_backend extends DV_Controller
{
	...
	function login()
	{
		if ($this->tank_auth->is_logged_in()) {									// logged in
			redirect($this->config->item('tank_auth.logged'));
	...
	function logout()
	{
		...
		{
			redirect($this->config->item('tank_auth.login'));	
		}
	...
	function _show_message($message)
	{
		...
		redirect($this->config->item('tank_auth.index'));
	}
