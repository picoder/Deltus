...
class Auth extends MX_Controller
{
	function __construct()
	{
		...
		// Includes redirects for controller
		$this->load->config('tank_auth/division_clutch', TRUE);
	...
	function login()
	{
		if ($this->tank_auth->is_logged_in()) {									// logged in
			...
			redirect('/tank_auth/auth/send_again/');
	...
	{
		if ($this->tank_auth->is_logged_in()) {									// logged in
			redirect($this->config->item('logged_in_dv', 'division_clutch'));
	...
	function activate()
	{
		$user_id		= $this->uri->segment(4); //to remember that this can be changed
