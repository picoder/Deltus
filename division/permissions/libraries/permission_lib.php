<?php
    ...
    class Permission_lib
    {
        ...
        public function backend_access($allowed_roles)
        {
            $this -> CI -> load -> library('tank_auth/tank_auth');
            $this -> CI -> load -> library('role/role_lib');
        ...
        public function backend_pm_login_access($allowed_roles)
        {
            $this -> CI -> load -> library('tank_auth/tank_auth');
            $this -> CI -> load -> library('role/role_lib');
        ...
        public function backend_pm_logout_access($allowed_roles)
        {
            $this -> CI -> load -> library('tank_auth/tank_auth');
        ...
        public function backend_pm_forgot_access($allowed_roles)
        {
            $this -> CI -> load -> library('tank_auth/tank_auth');
