...
<head>
	...
	<script language="javascript" type="text/javascript" src="ajaxfilemanager/jscripts/general.js"></script>
...
<body>
	<textarea id="ajaxfilemanager" name="ajaxfilemanager" style="width: 100%; height: 800px; border: 1px #AAA solid;"><h1>Ajax File/Image Manager Plugin</h1>
	<p>
